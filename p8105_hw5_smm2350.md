...
![](p8105_hw5_smm2350_files/figure-gfm/result-1.png)<!-- -->
...
![](p8105_hw5_smm2350_files/figure-gfm/spaghetti-1.png)<!-- -->
...
For numeric variables, I will fill in missing values with the mean of
non-missing values. For character variables, I will fill in missing
values with “virginica”. To do so, I will write a function that takes a
vector as an argument; replaces missing values accordingly; and returns
the resulting vector. I will then apply this function to the columns of
